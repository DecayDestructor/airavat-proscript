    ...
    <div className="flex flex-col h-screen ">
      ...
      <div className="flex-1 overflow-auto">
        <div className="py-6 px-8 max-w-4xl mx-auto">
          <h1 className="text-2xl font-semibold text-gray-900 mb-6">Create Prescription</h1>
          ...
          <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg px-8 pt-6 pb-8 mb-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="col-span-2">
                <h2 className="text-lg font-medium text-gray-900 mb-4">Medication Information</h2>
                ...
                <div className="flex flex-wrap -mx-2">
                  ...
                  <div className="w-full md:w-1/2 px-2 mb-4">
                    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="dosages">
                      Dosages (mg)*
                    </label>
                    <input
                      className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-teal-500"
                      ...
                      required
                    />
                    <p className="text-xs text-gray-500 mt-1">Note: Dosages exceeding 100mg will be capped at 100mg</p>
                  </div>
                </div>
                
                <div className="mb-4">
                  <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="medication_end_date">
                    Medication End Date*
                  </label>
                  <input
                    className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-teal-500"
              ...
              <div className="col-span-2">
                <h2 className="text-lg font-medium text-gray-900 mb-4">Upload Prescription Image</h2>
                <div className="mb-4">
                  <div className="flex items-center justify-center w-full">
                    <label className="w-full flex flex-col items-center px-4 py-6 bg-white text-teal-500 rounded-lg shadow-lg tracking-wide uppercase border border-teal-500 cursor-pointer hover:bg-teal-500 hover:text-white">
                      ...
                      <span className="mt-2 text-base leading-normal">Upload Written Prescription</span>
                      <input
                        type="file"
                        className="hidden"
                        accept="image/*"
                  ...
                  <div className="mt-3 text-sm text-gray-600">
                    ...
                    <ul className="list-disc list-inside mt-1">
                      ...
                      <li>Contains all medication details, including dosages</li>
